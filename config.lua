...
Config.Skillbar = "ps-ui"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","ps-ui","qb-skillbar"]
Config.targetExport = "qb-target"                               -- The name of the Target export you are using ["qb-target", "qtarget", "bt-target"]
	-- ps-ui settings
Config.MinigameCirclesMin = 2 -- Minigame: Minimum amount of circles
Config.MinigameCirclesMax = 3 -- Minigame: Maximum amount of circles
Config.MinigameTime = 20 -- Minigame: Amount of time in seconds
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	...
	},
    {
		...
		coords = vector3(3806.75, 4442.24, 2.90),         -- Regular/Exotic Fish Sells
		heading = 53.93,
		gender = "male",
        scenario = "WORLD_HUMAN_CLIPBOARD"
	},
