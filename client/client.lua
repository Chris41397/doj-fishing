...
RegisterNetEvent('fishing:SkillBar', function(message)
    ...
    end, math.random(Config.MinigameCirclesMin, Config.MinigameCirclesMax), Config.MinigameTime)
...
openedTreasureChest = function()
	...
	TriggerServerEvent('doj-fishing:server:removekey')
	TriggerServerEvent('doj-fishing:server:treasurechest')
